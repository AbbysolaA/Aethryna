...
Route::get('/robots.txt', function () {
    ...
    $private = [
        ...
        '# /register is deliberately absent: it is the application page, not a',
        '# sign-up form. It carries its own copy about the cohort and is the',
        '# page somebody searching for how to apply should be able to land on.',
        'Disallow: /login',
        'Disallow: /password/',
        'Disallow: /email/',
        'Disallow: /dashboard',
