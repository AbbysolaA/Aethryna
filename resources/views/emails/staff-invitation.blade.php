{{--
    Staff invitation. Extends emails.layout — supplies <tr> rows only.

    Data expected (see App\Mail\StaffInvitation):
        firstName, roleLabel, roleBlurb, email, acceptUrl, invitedBy, expiresDays
--}}
    ...
    <tr>
        <td class="sc-pad" style="padding:36px 32px 0 32px;">
            ...
            <p style="margin:14px 0 0 0; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:16px; line-height:26px; color:#2b333a;">
                {{ $invitedBy }} has set up an account for you at Skills Co-op. Choose a password and it is ready to use.
            </p>
        </td>
    </tr>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#eef6f4; border-left:4px solid #055860; border-radius:6px;">
                <tr>
                    <td style="padding:20px 22px;">
                        ...
                        <p style="margin:0 0 10px 0; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:20px; line-height:28px; font-weight:700; color:#2b333a;">
                            {{ $roleLabel }}
                        </p>
                        <p style="margin:0 0 16px 0; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:15px; line-height:24px; color:#2b333a;">
                            {{ $roleBlurb }}
                        </p>

                        <p style="margin:0 0 3px 0; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:11px; font-weight:700; letter-spacing:1.2px; text-transform:uppercase; color:#8a8f86;">
                            Sign in with
                        </p>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" class="sc-btn">
                <tr>
                    <td align="center" bgcolor="#055860" style="border-radius:6px;">
                        <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $acceptUrl }}" style="height:46px;v-text-anchor:middle;width:220px;" arcsize="13%" stroke="f" fillcolor="#055860">
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:15px;font-weight:bold;">Set your password</center>
                        </v:roundrect>
                        <![endif]-->
                        <!--[if !mso]><!-- -->
                        <a href="{{ $acceptUrl }}" style="display:inline-block; padding:14px 30px; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:15px; font-weight:700; color:#ffffff; text-decoration:none; border-radius:6px; background-color:#055860;">
                            Set your password
                        </a>
                        <!--<![endif]-->
                    </td>
                ...
                <tr>
                    <td style="padding-top:16px;">
                        <p style="margin:0 0 10px 0; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:15px; line-height:24px; color:#2b333a;">
                            <strong style="color:#055860;">This link lasts {{ $expiresDays }} days.</strong>
                            If it has expired by the time you get to it, ask and we will send another.
                        </p>
                        <p style="margin:0; font-family:'Karla',Arial,Helvetica,sans-serif; font-size:14px; line-height:22px; color:#8a8f86;">
                            Nobody at Skills Co-op knows or can see your password. If you were not expecting this, do not use the link, and tell us.
                        </p>
                    </td>
                </tr>
            </table>
